...
public:
    ...
    void DrawEllipse(float x, float y, const glm::vec2 &vector2) override;
    void DrawLine(float x1, float y1, float x2, float y2) override;
    void DrawLine(const glm::vec2 &pos, const glm::vec2 &size) override;
    void DrawRectangle(const glm::vec2 &pos, const glm::vec2 &size) override;
    void DrawRectangle(float x, float y, float width, float height) override;
    void DrawString(const std::wstring &string, const glm::vec2 &position, const FontFormat &format, int len) override;
    void FillEllipse(float x, float y, float width, float height) override;
    void FillEllipse(const glm::vec2 &pos, const glm::vec2 &size) override;
    void FillRectangle(float x, float y, float width, float height) override;
    void FillRectangle(const glm::vec2 &pos, const glm::vec2 &size) override;
