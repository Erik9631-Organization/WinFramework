...
namespace OpenGL
{
    ...
    public:
        ...
        void SetTexture(const std::string &textureTag) override;
        void SetMesh(const std::string &meshTag) override;
        void SetShaderProgram(const std::string shaderTag) override;
    };
}
