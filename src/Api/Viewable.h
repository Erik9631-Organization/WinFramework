...
public:
	...
	virtual void SetViewportOffset(glm::vec4 offset) = 0;
	virtual int GetViewportAbsoluteX() = 0;
	virtual int GetViewportAbsoluteY() = 0;
	virtual glm::vec4 GetViewportAbsolutePosition() = 0;
	...
	virtual void SetViewportSize(glm::vec4 size) = 0;
	...
	virtual glm::vec4 GetViewportAbsoluteSize() = 0;
