...
public:
	...
	void SetBorderColor(glm::ivec3 borderColor);
	void SetFillColor(glm::ivec3 color);

	void SetBorderColor(glm::ivec4 borderColor);
	void SetFillColor(glm::ivec4 color);
